...
#                 --train \
#                 --gpu_id 2 \
#                 --name 'unlearn_CFP_OS_class_1_sota_sgld_closest_points_unlearning_NO_scale_DELETE' \
...
python main.py --forget_class 1 \
               ...
               --gpu_id 2 \
                ...
                --run_sota \
                --do_unlearning \
               --name  'unlearn_OCT_OS_class_1_sota_sgld_closest_points_unlearning_NO_scale' \
                --original_model 'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_original_model_15.pth' \
                --retrain_model  'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_retrain_model_class_1_15.pth' 
...
python main.py --forget_class 1 \
               ...
               --gpu_id 2 \
                ...
                --do_unlearning \
                --scaling inverse \
               --name  'unlearn_OCT_OS_class_1_sota_sgld_closest_points_unlearning_INVERSE_scale' \
                --original_model 'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_original_model_15.pth' \
                --retrain_model  'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_retrain_model_class_1_15.pth' 
...
python main.py --forget_class 1 \
               ...
               --name  'unlearn_OCT_OS_class_1_sota_sgld_closest_points_unlearning_EXPONENTIAL_scale' \
                --original_model 'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_original_model_15.pth' \
                --retrain_model  'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_retrain_model_class_1_15.pth' 
...
python main.py --forget_class 1 \
               ...
               --name  'unlearn_OCT_OS_class_1_sota_sgld_closest_points_unlearning_LINEAR_scale' \
                --original_model 'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_original_model_15.pth' \
                --retrain_model  'model_checkpoints/resnet_open_source_oct/resnetoct_4_class_retrain_model_class_1_15.pth' 
